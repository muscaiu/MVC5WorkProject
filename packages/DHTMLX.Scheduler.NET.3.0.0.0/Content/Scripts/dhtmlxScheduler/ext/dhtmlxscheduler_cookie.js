...
e[0]=this.templates.xml_date(e[0]);window.setTimeout(function(){a.setCurrentView(e[0],e[1])},1);return!1}}var k=escape(this.templates.xml_format(d||b)+"@"+(c||g));i(f,"expires=Sun, 31 Jan 9999 22:00:00 GMT",k);return!0});var f=a._load;a._load=function(){var g=arguments;if(!a._date&&a._load_mode){var b=this;window.setTimeout(function(){f.apply(b,g)},1)}else f.apply(this,g)}})()});
